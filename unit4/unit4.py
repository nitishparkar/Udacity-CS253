...
class U4SignUp(webapp2.RequestHandler):
    def my_renderer(self, **params):
        template = jinja_environment.get_template('sutmpl.htm')
...
class U4Welcome(webapp2.RequestHandler):
...
class U4Login(webapp2.RequestHandler):
    def my_renderer(self,error1=""):
        template = jinja_environment.get_template('sitmpl.htm')
...
class U4Logout(webapp2.RequestHandler):
    def get(self):
